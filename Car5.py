...
def Main():
        ...
        listeningPort = 5005 #Car1 is 5001, Car2 is 5002, Car3 is 5003, etc...
        hostLower = '192.168.1.14' #Send back to this IP. Car1 is ..1.11, Car2 is ...1.12, Car3 is 1.13, etc...
        portLower = 5004
        hostUpper = '192.168.1.16' #Pass message on (send) to this IP
        portUpper = 5006
